...
toplot<-as.character(head(famf$Var1, n=30)) #select the top 9 families with 5 for more species
...
p <- 
  ...
  #geom_cladelabel(node=num_monocot, label=" ", offset = 6, color="darkorchid1", barsize = 0.6, angle = "auto") +
  #geom_cladelabel(node=num_dicot, label=" ", offset = 6, color="green2", barsize = 0.6, angle = "auto") +
...
#save output:
png("phylo_ring_co2withheat.png",
