...
TraitSyndrome<-alldat_cat_full %>%
  ...
  mutate(syndrome=ifelse(photosynthetic_pathway=="C4/CAM", 'C4/CAM',
                         ...
                         ifelse(growth_form=='forb'&lifespan=='Perenn./Bienn.'&mycorrhizal_type=='none'&n_fixation_type=='none', 'Non-mutualistic forb', 
...
pdf("syndromes_by_treat_contMay2025_v2.pdf", width = 6, height=10)
